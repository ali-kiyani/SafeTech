...
{
    public abstract class ForeSparkWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ForeSparkWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ForeSparkWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ForeSparkDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ForeSparkDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ForeSparkDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ForeSparkDbContext, Task<T>> func)
        {
            T result;
