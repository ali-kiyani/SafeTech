...
class RequestSubmitPage extends StatefulWidget {
  // var cameras;

  //DashboardPage(this.cameras);
  @override
  _RequestSubmitPageState createState() => _RequestSubmitPageState();
}

class _RequestSubmitPageState extends State<RequestSubmitPage> {
  @override
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'Thank you! Your request has been successfuly submitted with Tracking ID: 123456',
                              style: GoogleFonts.poppins(
                                  fontStyle: FontStyle.normal,
